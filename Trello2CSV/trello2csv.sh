...
# Special thanks to
#    https://gist.github.com/mgeh/8644a15a96759921505fd531a0cb8f2f
#    https://help.trello.com/article/759-getting-the-time-a-card-or-board-was-created
jq -r '
    (
        ["Long ID", "Short ID", "Item", "Background", "Short URL", "List", "Card Closed", "List Closed", "Label 1", "Label 2", "Label 3", "Label 4", "Label 5"], 
        ...
        .cards[] | 
        [.id, .idShort, .name, .desc, .shortUrl, $listNames[.idList], .closed, $listStatuses[.idList], $labelNames[.labels[].id]]
    ) | @csv' < "${download_file}"
